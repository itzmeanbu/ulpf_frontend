...
export function AuthProvider({ children }) {
  ...
  // Backend's /auth/register only returns { status: 'pending' } — new accounts
  // need an admin to approve them before they can log in. There is no token
  // and no user object yet, so we don't try to log the person in here.
