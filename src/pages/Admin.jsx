...
const TABS = ['Overview', 'Users', 'Access requests', 'Alerts', 'Log sources', 'Log access', 'Audit log', 'Reports', 'Settings'];
              ...
              <tr key={u.id}>
                ...
                <td>
                  <div className="pg-row">
                    ...
                    <button className="pg-btn small danger" onClick={() => window.confirm(`Delete ${u.email}? They can sign up again later.`) && run(() => adminService.deleteUser(u.id), 'User deleted.')}>Delete</button>
                  </div>
                </td>
              </tr>
            ))}
